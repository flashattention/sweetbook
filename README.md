...
로그인한 **모든 사용자**에게 완성된 샘플 프로젝트 2종이 홈 화면에 자동으로 표시됩니다.
...
- 신규 가입자도 온보딩 직후 즉시 완성된 샘플을 볼 수 있어 서비스 가치를 빠르게 이해할 수 있습니다.
- 샘플을 주문할 때 현재 사용자 계정으로 자동 복제되어 원본은 항상 보존됩니다.
- `db:reset` 이후에도 샘플이 재생성됩니다.
